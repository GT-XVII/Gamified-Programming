...
\begin{center}
\leavevmode
\includegraphics[width=212pt]{class_http_client__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=212pt]{class_http_client__coll__graph}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{class_http_client_a0d37d834a1d6eb09082a945747defcb6}{constructor}} (\mbox{\hyperlink{esm_2src_2bucket_8js_a451094c82c509e4de33de7f8df781a35}{retry}})
\item 
\mbox{\hyperlink{class_http_client_a88c78b84a7868abfe61aee0ad3db80ef}{send}} (\mbox{\hyperlink{rxjs_8umd_8js_a729ec4717f914fce241d4dccc9a03066}{config}})
\item 
...
\Hypertarget{class_request_client_ae4342651364bc3bc21c1a41116fd459b}\index{HttpClient@{HttpClient}!backOffDelayMillis@{backOffDelayMillis}}
\index{backOffDelayMillis@{backOffDelayMillis}!HttpClient@{HttpClient}}
...
\end{center}
\end{figure}
\Hypertarget{class_http_client_a0d37d834a1d6eb09082a945747defcb6}\index{HttpClient@{HttpClient}!constructor@{constructor}}
\index{constructor@{constructor}!HttpClient@{HttpClient}}
\doxysubsubsection{\texorpdfstring{constructor()}{constructor()}}
{\footnotesize\ttfamily \label{class_http_client_a0d37d834a1d6eb09082a945747defcb6} 
Http\+Client\+::constructor (\begin{DoxyParamCaption}\item[{}]{retry}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



References \mbox{\hyperlink{esm_2src_2bucket_8js_a451094c82c509e4de33de7f8df781a35}{retry}}.

\Hypertarget{class_request_client_aebd076b8d145f53fd3faf2ba131e9a53}\index{HttpClient@{HttpClient}!createRequestResponse@{createRequestResponse}}
\index{createRequestResponse@{createRequestResponse}!HttpClient@{HttpClient}}
...
\end{center}
\end{figure}
\Hypertarget{class_request_client_a489c5124785f2aabff57f9ed093f69b2}\index{HttpClient@{HttpClient}!getRetryDelayMillis@{getRetryDelayMillis}}
\index{getRetryDelayMillis@{getRetryDelayMillis}!HttpClient@{HttpClient}}
...
\end{center}
\end{figure}
\Hypertarget{class_request_client_a41a647201a363e47d674e1230788d728}\index{HttpClient@{HttpClient}!isRetryEligible@{isRetryEligible}}
\index{isRetryEligible@{isRetryEligible}!HttpClient@{HttpClient}}
...
\end{center}
\end{figure}
\Hypertarget{class_request_client_afc604c35dac88ed06c67a6f3c200286e}\index{HttpClient@{HttpClient}!parseRetryAfterIntoMillis@{parseRetryAfterIntoMillis}}
\index{parseRetryAfterIntoMillis@{parseRetryAfterIntoMillis}!HttpClient@{HttpClient}}
...
References \mbox{\hyperlink{rxjs_8umd_8js_a729ec4717f914fce241d4dccc9a03066}{config}}, and \mbox{\hyperlink{class_http_client_a34393c58179c8f4a1cc773637816a6d1}{send\+With\+Retry()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{class_http_client_a88c78b84a7868abfe61aee0ad3db80ef_cgraph}
\end{center}
\end{figure}
\Hypertarget{class_http_client_a34393c58179c8f4a1cc773637816a6d1}\index{HttpClient@{HttpClient}!sendWithRetry@{sendWithRetry}}
\index{sendWithRetry@{sendWithRetry}!HttpClient@{HttpClient}}
...
Http\+Client\+::send\+With\+Retry (\begin{DoxyParamCaption}\item[{}]{config}{, }\item[{}]{retry\+Attempts}{ = {\ttfamily 0}}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\end{center}
\end{figure}
\Hypertarget{class_request_client_a1cdd7dd8052b01282ec11099dc018ae2}\index{HttpClient@{HttpClient}!waitForRetry@{waitForRetry}}
\index{waitForRetry@{waitForRetry}!HttpClient@{HttpClient}}
